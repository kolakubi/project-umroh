...
<body style="padding: 0 10px;">
	...
	<div class="container">
        ...
        >
            ...
            <!-- form -->
			<div class="col-md-4 col-sm-12 col-xs-12" style="background-color: #00abc5; padding: 10px 20px; border-radius: 7px">
				<?php if($gagal) : ?>
            ...
            <div class="well" style="font-size: 1.2em">Belum punya akun ? <a href="<?php echo base_url()?>daftarakun" style="width: 100%;color: blue">Daftar.</a></div>
